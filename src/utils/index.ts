 ...
 */
export const authenticateCeramic = async (ceramic: CeramicClient, compose: ComposeClient) => {
...
const authenticateKeyDID = async (ceramic: CeramicClient, compose: ComposeClient) => {
...
const authenticateEthPKH = async (ceramic: CeramicClient, compose: ComposeClient) => {
